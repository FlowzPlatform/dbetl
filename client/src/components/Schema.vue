...
<template>
  <div class="schema">
    <!-- {{$route.params.id}} -->
  <f-Tab v-if="$route.params.id != undefined">
  </f-Tab>
            ...
            <Collapse>
              <Panel name="1">
                ...
                <Poptip trigger="hover" placement="bottom">
                   <Button>+</Button>
                   <div slot="content">
                     <p @click="opengrapesjs(true)">Using Grapes</p>
                     <br><p @click="openGridManager(true)">Using Grid Manager</p>
                  </div>
                </Poptip>
              </Panel>
            </Collapse>
            ...
            <Collapse>
              <Panel name="1">
                ...
                <Poptip trigger="hover" placement="bottom">
                   <Button>+</Button>
                   <div slot="content">
                     <p @click="opengrapesjs(false)">Using Grapes</p>
                     <br><p @click="openGridManager(false)">Using Grid Manager</p>
                  </div>
                </Poptip>
              </Panel>
            </Collapse>
            ...
            <Collapse>
              <Panel name="1">
                ...
                <Poptip trigger="hover" placement="bottom">
                   <Button>+</Button>
                   <div slot="content">
                     <p @click="openMjmlEditor">Add Template</p>
                  </div>
                </Poptip>
              </Panel>
            </Collapse>
